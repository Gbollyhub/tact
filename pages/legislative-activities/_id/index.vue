      ...
      <div class="container-default w-container">
        <div class="shop-hero-wrapper">
          <div class="split-content shop-hero-left detailed">
            <a href="/legislative-activities" class="arrow-link-wrapper detailed"><span class="link-arrow reversed"></span>Back to Legislative activities</a>
...
export default {
  ...
  components: { HeroSection, FProgram, AuthorCard },
    ...
    const  data  = await axios.get(`${process.env.STRAPI_URL}/legislative-activities/${params.id}`)
    return {
      post: data.data
      }
   },
