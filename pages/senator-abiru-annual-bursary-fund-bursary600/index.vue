<template>
  <div>
          ...
          >
            ...
            >
              <div class="slider-mask w-slider-mask">
                <div
                  class="w-slide"
                  v-for="(item, index) in post.HeroImages"
                  :key="index"
                >
                  <img
                    :src="item.url"
    ...
    <div id="landing-detail-section" class="section detailsed wf-section">
      <div class="container-default w-container">
          ...
          <div>
            <div class="blog-post-body-wrapper">
              <div class="split-content blog-post-body-left">
                <div
                  data-w-id="16c374cf-a22c-7f17-ec83-1c2ed12e7ff9"
                  style="opacity: 0"
                  class="card futured-event-card mg-bottom-24px landingtemplate"
                >
                  <div class="split-content futured-event-card-left-content">
                    <div class="about-event-wrapper mg-bottom-24px">
                      <div>August 25, 2022</div>
                    </div>
                    <div>
                      <h3>
                        Senator Tokunbo Abiru Annual Bursary Fund (BURSARY 600-
                        2022 Edition). Now Open!
                      </h3>
                      <p>
                        AS part of my promise to MSMEs last year at our BUSINESS
                        AID workshop...<br />
                      </p>
                    </div>
                  </div>
                  <div class="split-content futured-event-card-right-content">
                    <!-- <img
                      src="images/senatorAbiru_msmefund_1.jpg"
                      loading="eager"
                      srcset="
                        images/senatorAbiru_msmefund_1.jpg  500w,
                        images/senatorAbiru_msmefund_1.jpg  800w,
                        images/senatorAbiru_msmefund_1.jpg 1080w
                      "
    ...
    srcdoc="
                  ...
                  <html lang='en'>
                    <head>
                      ...
                      />
                      <title>MSME Revolving Loan - Application Form 1</title>
                      <style>
            * {
                margin: 0;
                padding: 0;
            ...
            iframe {
                border-radius: 0 !important;
                    ...
                    <body>
                      <div id='wrapper' data-tf-widget='kfxHJ6mx' data-tf-inline-on-mobile='' data-tf-medium='snippet'></div>
...
></iframe>
              ...
              <div class="split-content blog-post-body-right">
                <div class="card author-card pagetemplate">
                  <!-- <img
                    src="images/press-sidecard-img.png"
                    loading="lazy"
                    alt=""
                  ...
                  >
                    <a
                      href="https://www.facebook.com/AbiruTokunboMukhail"
                      target="_blank"
                      class="social-link"
                      ></a
                    >
                    <a
                      href="https://twitter.com/tokunboabiru"
                      target="_blank"
                      class="social-link"
                      ></a
                    >
                    <a
                      href="https://www.instagram.com/abirutokunbomukhail"
                      target="_blank"
                      class="social-link"
                      ></a
                    >
                    <a
                      href="https://www.youtube.com/channel/UCxqO8IkM14DibcdjcMHk3iA"
                      target="_blank"
                      class="social-link"
                      ></a
                    >
...
export default {
  ...
  head() {
    return {
      ...
      title: "Event - Senator Mukhail Adetokunbo Abiru",
      meta: [
        {
          hid: "Event - Senator Mukhail Adetokunbo Abiru",
          name: "Event - Senator Mukhail Adetokunbo Abiru",
          content: "Event - Senator Mukhail Adetokunbo Abiru",
        },
      ],
    };
  },
